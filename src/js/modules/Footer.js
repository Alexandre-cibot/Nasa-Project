					          ...
					          <div className="container">
					            <div className="row">
					              <div className="col l6 s12">
					                ...
					                <p className="grey-text text-lighten-4">I've made this website to improve my knowledge using those <b>Technologies </b> : <br /><i>Html - Css - Javascript - React - NodeJS.</i> <br /> Also to work with an API. I use the the NASA Open API, available here <a href="https://api.nasa.gov/index.html">https://api.nasa.gov</a> to find Photos and descriptions trasnmited by the Rover.</p>
					              </div>
